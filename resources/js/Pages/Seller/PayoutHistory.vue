            ...
            <div class="methods-grid">
                ...
                >
                    ...
                    <div class="method-actions">
                        <button
                            class="btn-primary"
                            @click="setPrimaryMethod(method.id)"
                        >
                            Set Primary
                        </button>
                        <button
                            class="btn-secondary"
                            @click="editMethod(method.id)"
                        >
                            Edit
                        </button>
                    </div>
        ...
        <div v-if="showPayoutModal" class="modal-overlay">
            <div class="modal">
                    ...
                    <div class="payout-details-content">
                        ...
                        <div class="detail-section">
                            ...
                            <div class="orders-list">
                                <div
                                    v-for="order in selectedPayout?.orders"
                                    :key="order.id"
                                    class="order-item"
                                >
                                    <span class="order-id"
                ...
                <div class="modal-actions">
                    <button class="btn-secondary" @click="closePayoutModal">
                        Close
                    </button>
                    <button
                        class="btn-primary"
                        @click="downloadReceipt(selectedPayout)"
                    >
                        Download Receipt
                    </button>
                </div>
...
export default {
    ...
    setup() {
        ...
        const payouts = ref([
            ...
            },
            {
                ...
                orders: [
                    {
                        id: "ORD-2023-125",
                        date: "2023-12-25T16:30:00",
                        amount: 18000.0,
                    },
                    {
                        id: "ORD-2023-126",
                        date: "2023-12-28T11:15:00",
                        amount: 14000.0,
                    },
                ],
            },
        ...
        const totalPayouts = computed(() => {
            return filteredPayouts.value.reduce(
                (total, payout) => total + payout.netAmount,
                0
            );
        });
        ...
        const pendingCount = computed(() => {
            return filteredPayouts.value.filter((p) => p.status === "pending")
                .length;
        });

        const payoutCount = computed(() => filteredPayouts.value.length);
        const averagePayout = computed(() => {
            return payoutCount.value > 0
                ? totalPayouts.value / payoutCount.value
                : 0;
        });
        const totalFees = computed(() => {
            return filteredPayouts.value.reduce(
                (total, payout) => total + payout.fees + payout.processingFees,
                0
            );
        });
