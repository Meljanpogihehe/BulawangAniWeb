    ...
    <div class="product-list">
        ...
        <div class="page-header">
            ...
            <div class="header-actions">
                ...
                <button
                    class="btn-primary"
                    @click="navigateTo('/seller/add-product')"
                >
            ...
            >
                ...
                <div class="table-cell">
                    <div class="price-info">
                        <div
                            class="price"
                            :class="{ 'on-sale': product.salePrice }"
                        >
        ...
        <div v-if="selectedProducts.length > 0" class="bulk-actions">
            ...
            <div class="bulk-actions-group">
                ...
                <button class="btn-primary" @click="executeBulkAction">
                    Apply
                </button>
            </div>
        </div>
                ...
                <div class="product-detail-content">
                    <div class="detail-section">
                        ...
                        <div class="detail-grid">
                            ...
                            <div
                                class="detail-item"
                                v-if="selectedProduct.salePrice"
                            >
                            ...
                            <div class="detail-item">
                                ...
                                <span
                                    :class="
                                        getStockStatusClass(selectedProduct)
                                    "
                                    >{{
    ...
    setup() {
        ...
        const averageRating = computed(() => {
            ...
            return products.value.length > 0
                ? (total / products.value.length).toFixed(1)
                : 0;
        });
        ...
        const selectAll = computed({
            ...
            set(value) {
                if (value) {
                    selectedProducts.value = filteredProducts.value.map(
                        (p) => p.id
                    );
                } else {
        ...
        const executeBulkAction = () => {
            if (!bulkAction.value || selectedProducts.value.length === 0)
                return;
            ...
            switch (bulkAction.value) {
                ...
                case "delete":
                    if (
                        confirm(
                            `Delete ${selectedProducts.value.length} products?`
                        )
                    ) {
                        selectedProducts.value.forEach((id) => {
                            const index = products.value.findIndex(
