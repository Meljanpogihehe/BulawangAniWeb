                ...
                <div class="action-card" @click="bulkAccept">
                    ...
                    <div class="action-content">
                        ...
                        <div class="action-subtitle">
                            {{ orderStats.pending }} orders to process
                        </div>
                    </div>
                </div>
    ...
    setup() {
        ...
        const orderStats = computed(() => {
            return {
                ...
                shipped: orders.value.filter((o) => o.status === "shipped")
                    .length,
                delivered: orders.value.filter((o) => o.status === "delivered")
                    .length,
            };
        });
